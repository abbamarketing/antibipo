        ...
        tools: [
          {
            ...
            function: {
              ...
              parameters: {
                type: "object",
                properties: {
                  tipo: { type: "string", enum: ["estrategico", "operacional", "delegavel", "administrativo", "domestico"] },
                  estado_ideal: { type: "string", enum: ["foco_total", "modo_leve", "basico", "qualquer"] },
                  urgencia: { type: "integer", enum: [1, 2, 3] },
                  impacto: { type: "integer", enum: [1, 2, 3] },
                  dono: { type: "string", enum: ["eu", "socio_medico", "editor"] },
                  tempo_min: { type: "integer" },
                  modulo: { type: "string", enum: ["trabalho", "casa", "saude"] },
                },
                required: ["tipo", "estado_ideal", "urgencia", "impacto", "dono", "tempo_min", "modulo"],
